...
import createDBDialogReducer from "./createDBDialogReducer";
...
const rootReducer = combineReducers({
  ...
  createDBDialog: createDBDialogReducer,
...
export const initialState: State = {
  ...
  createDBDialog: createDBDialogInitState,
